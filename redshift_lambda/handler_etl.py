...
def reformat_customer_info(data):
...
def reformat_cafe_locations_info(data):
...
def reformat_datetime_info(data):
...
def reformat_payment_info(data):
...
def reformat_purchases_for_sql(data):
